...
func main() {
	...
	e = db.Transaction(func(tx *gorm.DB) error {
		...
		items := []model.RewardItem{
			...
			{ItemCode: "1207753", Name: "爱你万年·铭文版戒指", ItemType: "item", ImageURL: "https://resource-inner.afunapp.com/admin/67EDC309-9680-458F-99D5-90D1F524637C.png?x-oss-process=image%2Fresize%2Cm_lfit%2Ch_200%2Cw_200", AnimationURL: "https://fe-center.afunapp.com/page-center/assets/zBvuCpRS/EZZaxmK2.svg?_w=150&_h=150", Status: 1},
		}
